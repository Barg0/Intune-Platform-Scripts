# Script version:   2025-08-12 16:15
# Script author:    Barg0
...
$scriptName = "Application - Microsoft Office - Meeting Room"
...
$registryKeys = @(
    @{
        ...
        KeyPath     = 'Software\Policies\Microsoft\Office\16.0\Outlook\Cached Mode'
        ValueName   = 'SyncWindowSetting'
        ValueData   = 0
        ValueType   = 'DWord'
    },
    @{
        Hive        = 'HKEY_CURRENT_USER'
        KeyPath     = 'Software\Policies\Microsoft\Office\16.0\Outlook\Cached Mode'
        ValueName   = 'SyncWindowSettingDays'
        ValueData   = 3
        ValueType   = 'DWord'
    }
)
