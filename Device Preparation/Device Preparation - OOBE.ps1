# Script version:   2025-08-09 16:20
# Script author:    Barg0
...
$scriptName = "Device Preparation - OOBE"
...
$registryKeys = @(
    @{
        ...
        KeyPath     = 'SOFTWARE\Microsoft\Windows\CurrentVersion\OOBE'
    ...
    @{
        Hive        = 'HKEY_LOCAL_MACHINE'
        KeyPath     = 'SOFTWARE\Microsoft\Windows\CurrentVersion\OOBE'
        ValueName   = 'PrivacyConsentStatus'
        ValueData   = 1
        ValueType   = 'DWord'
    },   
