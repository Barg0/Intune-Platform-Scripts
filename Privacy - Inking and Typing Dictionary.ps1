# Script version: 2025-05-04 09:40
...
$registryKeys = @(
    @{
        ...
        KeyPath     = 'Software\Microsoft\Windows\CurrentVersion\CPSS\Store\InkingAndTypingPersonalization'
        ValueName   = 'Value'
        ValueData   = 0
        ValueType   = 'DWord'
    },
...
$scriptName = "Privacy - Inking and Typing Dictionary"
